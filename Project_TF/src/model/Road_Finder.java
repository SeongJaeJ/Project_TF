...
public class Road_Finder {
	...
	private int road_finder_transport_type;
	...
	public int getRoad_finder_transport_type() {
	...
	public void setRoad_finder_transport_type(int road_finder_transport_type) {
	...
	public String toString() {
		return "Road_Finder [road_finder_index=" + road_finder_index + ", daily_trip_index=" + daily_trip_index
				+ ", road_finder_transport_type=" + road_finder_transport_type + ", road_finder_filename="
				+ road_finder_filename + ", road_finder_regdate=" + road_finder_regdate + ", road_finderList="
				+ road_finderList + "]";
	}
