...
<!-- 						<label class="btn btn-primary active"> -->
							<input type="radio" name="options" onclick="selectTansportType(0)" id="option1" autocomplete="off" checked>자동차
<!-- 						</label> -->
<!-- 						<label class="btn btn-primary"> -->
							<input type="radio" name="options" onclick="selectTansportType(1)" id="option2" autocomplete="off">대중교통
<!-- 						</label> -->
<!-- 						<label class="btn btn-primary"> -->
							<input type="radio" name="options" onclick="selectTansportType(2)" id="option3" autocomplete="off">자전거
<!-- 						</label> -->
<!-- 						<label class="btn btn-primary"> -->
							<input type="radio" name="options" onclick="selectTansportType(3)" id="option4" autocomplete="off">도보
<!-- 						</label> -->
<!-- 					</div> -->
					<div id="routesNav"></div>
				</div>
				<div class="col-sm-7">
					<div id="map" style="height:710px;width:100%" class=""></div><br><br>
				</div>
