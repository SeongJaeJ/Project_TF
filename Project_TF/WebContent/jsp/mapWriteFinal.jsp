				...
				<div class="col-sm-2">
					...
					<br><br>
						<ul id="search" class="text-center">
							...
							<li>
								<button class="btn btn-default" onclick="selectTansportType(3);alert('도보를 선택하셨습니다.');" id="walk" autocomplete="off" style="padding: 6px 12px 6px 12px;"><img src="${contextPath }/img/running (1).png" width="15px" height="15px">도보</button>
							</li>
						</ul>
					</div>	
     ...
     <form action="">
      <div class="container-fluid">
      	...
      	<div class="container last">
      		...
      		<div class="row">
      			<div class="col-sm-12">
      				<label class="pull-left"><img src="${contextPath }/img/sound-651706_640.png" style="width: 25px; height: 25px;">&nbsp;&nbsp;<font class="text-danger">회원들에게 알릴 글 제목과 소내용을 입력해주세요</font></label>
	      	<div class="row">
		      	<div class="col-sm-12">
		      		<br>
		      		<label>글 제목 : <input type="text" class="pull-left form-control" placeholder="제목을 입력해주세요"></label>
		      		<input type="text" class="form-control" placeholder="소내용을 입력해주세요">
		      	</div>	
	      	</div>			
	      <br><br><br><br><br>
	      <div class="row">
      ...
      <div class="wrap">	
      	<div class="row text-center">
      	  <div class="col-sm-12">
	      	  <input type="reset" value="다시 쓰기" class="btn btn-danger primary">
		      <input type="submit" value="등록" class="btn btn-success primary">
