...
<!--       					<th class="text-center"><a href="#" class="btn btn-info btn-lg"><span class="glyphicon glyphicon-calendar"></span>Schedule View</a></th> -->
      			...
      			<tbody>
      				<tr>
      					<td><p class="text-info text-center">1</p></td>
      					<td><p class="text-info text-center">서울 강남으로 놀러가요</p></td>
      					<td><p class="text-info text-center">서울</p></td>
      					<td><p class="text-info text-center">세균맨(tprbsaos12)</p></td>
      					<td><p class="text-info text-center">2박3일</p></td>
      					<td><p class="text-info text-center">10명</p></td>
      					<td><p class="text-info text-center">X</p></td>
      				</tr>
      			</tbody>
      		</table>
      	</div>
		...
		<div class="container-fluid one">
			<div class="row">
				<div class="col-sm-2">
					<img alt="" src="${contextPath }/img/경로2.png" height="100%" width="100%">
				</div>
				<div class="col-sm-7">
					<div id="googleMap" style="height:710px;width:100%" class=""></div><br><br>
				</div>
				<!-- 가볼만한곳 시작 -->
				<div class="col-sm-3">
    ...
    <form action="">
      <div class="container-fluid">
      		...
      		<table class="table table-hover">
      			<thead>
      				<tr>
      					...
      					<th class="text-center"><p class="text-primary">Rooms</p></th>
      					<th class="text-center"><p class="text-primary">Mens</p></th>
      					<th class="text-center"><p class="text-primary">Womans</p></th>
      					<th class="text-center"><p class="text-primary">Childrens</p></th>
      					<th class="text-center"><p class="text-primary">Party Mode</p></th>
      				</tr>
      			</thead>
      			<tbody>
      				<tr>
      					<td><p class="text-center text-primary"></p></td>
      					<td><p class="text-info text-center">2018/03/30~2018/09/24</p></td>
      					<td><p class="text-info text-center">Seoul</p></td>
      					<td><p class="text-info text-center">DaeJeon</p></td>
      					<td><p class="text-info text-center">Busan</p></td>
      					<td><p class="text-info text-center">318,000</p></td>
      					<td><p class="text-info text-center">약속장소는 서울역입니다.</p></td>
      					<td><p class="text-info text-center">5 Rooms</p></td>
      					<td><p class="text-info text-center">5 Mens</p></td>
      					<td><p class="text-info text-center">5 Womans</p></td>
      					<td><p class="text-info text-center">5 Childrens</p></td>
      					<td><p class="text-info text-center">O</p></td>
      				</tr>
      			</tbody>
      		</table>
      	</div>
      	...
      	<div class="container last">
      		<div class="row">
      			<div class="col-sm-12">
      				...
      				<textarea rows="10" cols="10" class="form-control" placeholder="글자수 2000자 제한입니다." readonly="readonly">1. 약속시간 늦지 않기 (늦으면 그냥 가버립니다.)&#10;2. ※정확한 시간엄수※&#10;3. 문의사항은 카톡 zang123&#10;4. 전화번호는 010-1234-1234 입니다.&#10;5. 문의는 꼭! 21시전까지만 연락해주세요
      				</textarea>
      			</div>
      		</div>
      	</div>
       ...
       <div class="row text-center">
      	  <div class="col-sm-12">
		      <a href="#" class="btn btn-info primary">목록보기</a>
...
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCGw_4PvKFgs6zcQBQikMbtvteC33M6He8&callback=myMap"></script>
</html>
